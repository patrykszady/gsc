 ...
 *
 * It was a standalone /admin/{site}/autopilot page, which put the dashboard's
...
class SeoReportsAutopilotMergeTest extends TestCase
{
    ...
    public function test_the_old_autopilot_url_redirects_permanently(): void
    {
        $response = $this->actingAs($this->operator())
            ->get('http://gs.construction/admin/gs.construction/autopilot');

        $response->assertStatus(301);
        $this->assertStringContainsString(
            '/admin/gs.construction/seo-reports',
