...
<button type="button" <?php echo e($attributes->class($classes)); ?> <?php if($invalid): ?> data-invalid <?php endif; ?> data-flux-group-target data-flux-time-picker-button>
...
<?php endif; ?>
    ...
    <?php else: ?>
        <?php if (isset($component)) { $__componentOriginal1b567a36d06f308facfb8b1f90484195 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1b567a36d06f308facfb8b1f90484195 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::time-picker.selected','data' => ['placeholder' => $placeholder]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::time-picker.selected'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1b567a36d06f308facfb8b1f90484195)): ?>
<?php $attributes = $__attributesOriginal1b567a36d06f308facfb8b1f90484195; ?>
<?php unset($__attributesOriginal1b567a36d06f308facfb8b1f90484195); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal1b567a36d06f308facfb8b1f90484195)): ?>
<?php $component = $__componentOriginal1b567a36d06f308facfb8b1f90484195; ?>
<?php unset($__componentOriginal1b567a36d06f308facfb8b1f90484195); ?>
<?php endif; ?>
    <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['as' => 'div','class' => 'cursor-pointer ms-2 '.e($size === 'sm' || $size === 'xs' ? '-me-1' : '-me-2').' [[data-flux-time-picker-button]:has([data-flux-time-picker-placeholder])_&]:hidden [[data-flux-select]:has([disabled])_&]:hidden','variant' => 'subtle','size' => $size === 'sm' || $size === 'xs' ? 'xs' : 'sm','square' => true,'tabindex' => '-1','ariaLabel' => 'Clear time','xOn:click.prevent.stop' => 'let timePicker = $el.closest(\'ui-time-picker\'); timePicker.clear();']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'div','class' => 'cursor-pointer ms-2 '.e($size === 'sm' || $size === 'xs' ? '-me-1' : '-me-2').' [[data-flux-time-picker-button]:has([data-flux-time-picker-placeholder])_&]:hidden [[data-flux-select]:has([disabled])_&]:hidden','variant' => 'subtle','size' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($size === 'sm' || $size === 'xs' ? 'xs' : 'sm'),'square' => true,'tabindex' => '-1','aria-label' => 'Clear time','x-on:click.prevent.stop' => 'let timePicker = $el.closest(\'ui-time-picker\'); timePicker.clear();']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.chevron-down','data' => ['variant' => 'mini','class' => 'ms-2 -me-1 text-zinc-300 [[data-flux-time-picker-button]:hover_&]:text-zinc-800 [[disabled]_&]:text-zinc-200! dark:text-white/60 dark:[[data-flux-time-picker-button]:hover_&]:text-white dark:[[disabled]_&]:text-white/40!']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'mini','class' => 'ms-2 -me-1 text-zinc-300 [[data-flux-time-picker-button]:hover_&]:text-zinc-800 [[disabled]_&]:text-zinc-200! dark:text-white/60 dark:[[data-flux-time-picker-button]:hover_&]:text-white dark:[[disabled]_&]:text-white/40!']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/patryk/web/gsc/vendor/livewire/flux-pro/stubs/resources/views/flux/time-picker/button.blade.php ENDPATH**/ ?>