...
<div <?php echo e($attributes->class($classes)); ?>>
    ...
    <div x-on:click.stop class="flex items-center" dir="ltr" wire:ignore>
        <input type="text" inputmode="numeric" data-flux-hour-input class="<?php echo e($inputClasses); ?>" />:
        <input type="text" inputmode="numeric" data-flux-minute-input class="<?php echo e($inputClasses); ?>" />&nbsp;
        <input type="text" data-flux-meridiem-input class="<?php echo e($inputClasses); ?>" />
    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['as' => 'div','class' => 'cursor-pointer [ui-time-picker:has([disabled])_&]:hidden','variant' => 'subtle','size' => $size === 'sm' || $size === 'xs' ? 'xs' : 'sm','square' => true,'tabindex' => '-1','ariaLabel' => 'Clear time','xOn:click.prevent.stop' => 'let timePicker = $el.closest(\'ui-time-picker\'); timePicker.clear();','inset' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['as' => 'div','class' => 'cursor-pointer [ui-time-picker:has([disabled])_&]:hidden','variant' => 'subtle','size' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($size === 'sm' || $size === 'xs' ? 'xs' : 'sm'),'square' => true,'tabindex' => '-1','aria-label' => 'Clear time','x-on:click.prevent.stop' => 'let timePicker = $el.closest(\'ui-time-picker\'); timePicker.clear();','inset' => true]); ?>
...
<?php endif; ?>
    ...
    <div class="<?php echo e($buttonClasses->add('flex items-center justify-center')); ?>">
...
<?php endif; ?>
    ...
    <?php else: ?>
        <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['square' => true,'variant' => 'subtle','class' => ''.e($buttonClasses).'','dataFluxTimePickerButton' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['square' => true,'variant' => 'subtle','class' => ''.e($buttonClasses).'','data-flux-time-picker-button' => true]); ?>
            <?php if (isset($component)) { $__componentOriginal4a4fffe04433d6d6be16f26ad2650578 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4a4fffe04433d6d6be16f26ad2650578 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.clock','data' => ['variant' => 'mini','class' => 'text-zinc-300 [[data-flux-time-picker-button]:hover_&]:text-zinc-800 [[disabled]_&]:text-zinc-200! dark:text-white/60 dark:[[data-flux-time-picker-button]:hover_&]:text-white dark:[[disabled]_&]:text-white/40!']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.clock'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'mini','class' => 'text-zinc-300 [[data-flux-time-picker-button]:hover_&]:text-zinc-800 [[disabled]_&]:text-zinc-200! dark:text-white/60 dark:[[data-flux-time-picker-button]:hover_&]:text-white dark:[[disabled]_&]:text-white/40!']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4a4fffe04433d6d6be16f26ad2650578)): ?>
<?php $attributes = $__attributesOriginal4a4fffe04433d6d6be16f26ad2650578; ?>
...
<?php /**PATH /home/patryk/web/gsc/vendor/livewire/flux-pro/stubs/resources/views/flux/time-picker/input.blade.php ENDPATH**/ ?>