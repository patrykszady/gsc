...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-718874256-0', null);
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-718874256-1', null);
            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:gap-12">
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-zinc-200 transition hover:shadow-xl dark:bg-zinc-800 dark:ring-zinc-700">
                    <div class="aspect-[16/9] overflow-hidden bg-gradient-to-br from-sky-500 to-blue-600">
                        <img 
                            src="<?php echo e(asset('images/services/kitchen-hero.jpg')); ?>" 
                    ...
                    <div class="p-8">
                        ...
                        <div class="mt-8">
                            <a 
                                href="<?php echo e(route('services.kitchen')); ?>" 
                                wire:navigate
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-zinc-200 transition hover:shadow-xl dark:bg-zinc-800 dark:ring-zinc-700">
                    <div class="aspect-[16/9] overflow-hidden bg-gradient-to-br from-indigo-500 to-purple-600">
                        <img 
                            src="<?php echo e(asset('images/services/bathroom-hero.jpg')); ?>" 
                    ...
                    <div class="p-8">
                        ...
                        <div class="mt-8">
                            <a 
                                href="<?php echo e(route('services.bathroom')); ?>" 
                                wire:navigate
                                class="inline-flex items-center gap-2 rounded-lg bg-sky-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
                            >
                                Learn More
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-zinc-200 transition hover:shadow-xl dark:bg-zinc-800 dark:ring-zinc-700">
                    <div class="aspect-[16/9] overflow-hidden bg-gradient-to-br from-emerald-500 to-teal-600">
                        <img 
                            src="<?php echo e(asset('images/services/home-hero.jpg')); ?>" 
                            alt="Home Remodeling" 
                            class="h-full w-full object-cover transition duration-300 group-hover:scale-105"
                            onerror="this.style.display='none'"
                        >
                    ...
                    <div class="p-8">
                        ...
                        <div class="mt-8">
                            <a 
                                href="<?php echo e(route('services.home')); ?>" 
                                wire:navigate
                                class="inline-flex items-center gap-2 rounded-lg bg-sky-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
                            >
                                Learn More
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-zinc-200 transition hover:shadow-xl dark:bg-zinc-800 dark:ring-zinc-700">
                    <div class="aspect-[16/9] overflow-hidden bg-gradient-to-br from-amber-500 to-orange-600">
                        <img 
                            src="<?php echo e(asset('images/services/basement-hero.jpg')); ?>" 
                    ...
                    <div class="p-8">
                        ...
                        <div class="mt-8">
                            <a 
                                href="<?php echo e(route('services.basement')); ?>" 
                                wire:navigate
                                class="inline-flex items-center gap-2 rounded-lg bg-sky-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
                            >
                                Learn More
...
<?php /**PATH /home/patryk/web/gsc/resources/views/services.blade.php ENDPATH**/ ?>