<div>
    <section
        x-data="{
            current: <?php if ((object) ('current') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('current'->value()); ?>')<?php echo e('current'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('current'); ?>')<?php endif; ?>,
            autoplay: null,
            touchStartX: 0,
            touchEndX: 0,
            getImage() {
