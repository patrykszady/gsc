<div wire:key="testimonials-section-<?php echo e($projectType ?? 'all'); ?>"
     x-data="{
        touchStartX: 0,
        touchEndX: 0,
        autoplay: null,
        ...
        startAutoplay() {
            ...
            this.stopAutoplay();
            this.autoplay = setInterval(() => $wire.nextTestimonial(), 5000);
        },
        stopAutoplay() {
            if (this.autoplay) {
                ...
                <div class="relative">
                    <figure class="grid grid-cols-1 items-start gap-x-6 gap-y-4 lg:grid-cols-[auto_1fr] lg:gap-x-10 lg:gap-y-2">
                        ...
                        <div class="relative row-span-3 hidden w-48 flex-col lg:flex xl:w-56">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($current['area_slug'])): ?>
                                        <a href="/areas/<?php echo e($current['area_slug']); ?>" class="hover:text-sky-600 hover:underline dark:hover:text-sky-400"><?php echo e($current['location'] ?? ''); ?></a>
                                    <?php else: ?>
                                        <span><?php echo e($current['location'] ?? ''); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($current['date'])): ?>
                                        <span> · </span>
                                        <span><?php echo e($current['date']); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative hidden flex-col lg:flex">
                            ...
                            <div>
                                <img
                                    src="<?php echo e(asset('images/gs construction five starts.png')); ?>"
                                    alt="5 Stars"
                                    class="h-7 w-auto"
                                />
                            </div>
                            ...
                            <div class="relative mt-4 h-40">
                                ...
                                <blockquote class="text-xl/8 text-gray-900 dark:text-white">
                                    <p class="line-clamp-5 italic transition-opacity duration-300"><?php echo e($current['description'] ?? ''); ?></p>
                                </blockquote>
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttons.cta','data' => ['href' => ''.e(route('testimonials.index')).'','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('testimonials.index')).'','size' => 'sm']); ?>
...
<?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($current['slug'])): ?>
                                <?php if (isset($component)) { $__componentOriginalc91de951028fe2f549c3df803b776551 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91de951028fe2f549c3df803b776551 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.buttons.cta','data' => ['href' => ''.e(route('testimonials.show', $current['slug'])).'','variant' => 'secondary','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('buttons.cta'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('testimonials.show', $current['slug'])).'','variant' => 'secondary','size' => 'sm']); ?>
                                    Show This Review
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91de951028fe2f549c3df803b776551)): ?>
...
<?php /**PATH /home/patryk/web/gsc/resources/views/livewire/testimonials-section.blade.php ENDPATH**/ ?>