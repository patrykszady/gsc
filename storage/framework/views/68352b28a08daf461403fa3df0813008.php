    ...
    <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div class="flex items-center gap-x-4">
            <a href="<?php echo e($homeUrl); ?>" wire:navigate.hover class="flex items-center gap-x-3">
                <img src="<?php echo e(asset('favicon-source.png')); ?>" alt="GS Construction" width="48" height="48" class="h-12 w-auto" />
        ...
        >
            <div class="flex items-center justify-between">
                <a href="<?php echo e($homeUrl); ?>" wire:navigate class="flex items-center gap-x-3">
                    <img src="<?php echo e(asset('favicon-source.png')); ?>" alt="GS Construction" width="40" height="40" class="h-10 w-auto" />
