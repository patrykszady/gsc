...
<?php echo app('flux')->scripts(); ?>
    ...
    <script>
        ...
        function loadDeferredScripts() {
            ...
            gaScript.async = true;
            gaScript.src = 'https://www.googletagmanager.com/gtag/js?id=<?php echo e(config('services.google.analytics_id')); ?>';
            ...
            <?php if(config('services.microsoft.clarity_id')): ?>
            // Microsoft Clarity
            ...
            <?php if(config('services.google.places_api_key')): ?>
