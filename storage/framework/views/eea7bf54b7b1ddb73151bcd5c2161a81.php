...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['square' => true,'variant' => 'subtle','size' => 'sm','ariaLabel' => 'Clear search input']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['square' => true,'variant' => 'subtle','size' => 'sm','aria-label' => 'Clear search input']); ?>
...
<?php endif; ?>
    ...
    <?php elseif ($clearable): ?>
        <div class="[[data-flux-pillbox-search]:has([data-flux-loading])_&]:opacity-0 transition-opacity absolute top-0 bottom-0 flex items-center justify-center pe-1 end-0 [[data-flux-pillbox-search]:has(input:placeholder-shown)_&]:hidden">
            <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['square' => true,'variant' => 'subtle','size' => 'sm','tabindex' => '-1','ariaLabel' => 'Clear command input','xOn:click' => '$el.closest(\'[data-flux-pillbox-search]\').querySelector(\'input\').value = \'\'; $el.closest(\'[data-flux-pillbox-search]\').querySelector(\'input\').dispatchEvent(new Event(\'input\', { bubbles: false })); $el.closest(\'[data-flux-pillbox-search]\').querySelector(\'input\').focus()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['square' => true,'variant' => 'subtle','size' => 'sm','tabindex' => '-1','aria-label' => 'Clear command input','x-on:click' => '$el.closest(\'[data-flux-pillbox-search]\').querySelector(\'input\').value = \'\'; $el.closest(\'[data-flux-pillbox-search]\').querySelector(\'input\').dispatchEvent(new Event(\'input\', { bubbles: false })); $el.closest(\'[data-flux-pillbox-search]\').querySelector(\'input\').focus()']); ?>
                <?php if (isset($component)) { $__componentOriginal155e76c41fe51242bc25d269fabf82f5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal155e76c41fe51242bc25d269fabf82f5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.x-mark','data' => ['variant' => 'micro']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.x-mark'); ?>
...
<?php /**PATH /home/patryk/web/gsc/vendor/livewire/flux-pro/stubs/resources/views/flux/pillbox/search.blade.php ENDPATH**/ ?>