...
<?php if ($as === 'button'): ?>
    <ui-button <?php echo e($attributes->class([$classes, $asButtonClasses])); ?> data-flux-kanban-card>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($header): ?>
            <div class="mb-2 [&:not(:has(>_*))]:hidden flex items-center gap-1.5"><?php echo e($header); ?></div>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($footer): ?>
            <div class="mt-2 [&:not(:has(>_*))]:hidden flex items-center gap-1.5"><?php echo e($footer); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </ui-button>
<?php else: ?>
    <div <?php echo e($attributes->class($classes)); ?> flux-kanban-card>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($header): ?>
            <div class="mb-2 [&:not(:has(>_*))]:hidden flex items-center gap-1.5"><?php echo e($header); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/patryk/web/gsc/vendor/livewire/flux-pro/stubs/resources/views/flux/kanban/card.blade.php ENDPATH**/ ?>