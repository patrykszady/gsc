    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto {{ $contentMaxWidth }}">
            ...
            <x-faq-card x-data="{ open: false }" class="overflow-visible">
                ...
                <div x-show="open" x-collapse x-cloak class="border-t border-zinc-200/80 px-0 py-5 dark:border-white/10">
            ...
            @endif
                @foreach($faqs as $faq)
                <x-faq-card x-data="{ open: false }">
                    <dt>
                        <button
                            type="button"
                            @click="open = !open"
                            class="flex w-full items-start justify-between px-5 py-4 text-left text-zinc-900 dark:text-white sm:px-6"
                            :aria-expanded="open"
                        >
                    ...
                    <dd x-show="open" x-collapse x-cloak class="border-t border-zinc-200/80 px-5 py-4 pr-12 dark:border-white/10 sm:px-6">
