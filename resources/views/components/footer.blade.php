                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-1">
                            ...
                            <li>
                                <a href="/reviews" wire:navigate.hover class="inline-block py-2 text-sm/6 text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-300">Reviews</a>
                            </li>
                            <li>
