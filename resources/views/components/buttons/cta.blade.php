...
@php
    ...
    $variants = [
        ...
        // Secondary's shape (sentence case, trailing arrow) in the brand blue.
        'outline-primary' => 'capitalize border border-sky-600 bg-white text-sky-600 hover:bg-sky-50 dark:bg-zinc-900 dark:text-sky-400 dark:hover:bg-sky-950',
...
>
    {{ $slot }}
    @if(in_array($variant, ['secondary', 'outline-primary'], true))
