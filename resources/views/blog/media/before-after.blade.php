        ...
        @foreach ($project->beforeAfters->take(3) as $pair)
            <figure>
                <div class="grid grid-cols-2 gap-3">
                    <a href="{{ $pair->before_url }}" target="_blank" rel="noopener" onclick="window.ssPulse && window.ssPulse('before_after')" class="relative block overflow-hidden rounded-xl">
                    ...
                    <a href="{{ $pair->after_url }}" target="_blank" rel="noopener" onclick="window.ssPulse && window.ssPulse('before_after')" class="relative block overflow-hidden rounded-xl">
