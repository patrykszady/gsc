...
>
    ...
    >
        ...
        <div class="prose prose-lg prose-zinc mt-10 max-w-none dark:prose-invert prose-headings:font-heading prose-headings:clear-both prose-a:text-sky-700 dark:prose-a:text-sky-400 prose-p:text-zinc-700 dark:prose-p:text-zinc-300">
