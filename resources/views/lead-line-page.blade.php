...
<x-layouts.app>
    <x-breadcrumbs :items="[
        ['label' => 'Areas Served', 'url' => url('/areas-served')],
        ['label' => $area->city, 'url' => url('/areas-served/' . $area->slug)],
        ['label' => 'Lead Pipe Replacement'],
    ]" maxWidth="max-w-3xl" padding="pt-10 pb-0 sm:pt-14" />
