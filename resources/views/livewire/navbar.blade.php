<header class="relative z-50 bg-white dark:bg-zinc-950" x-data="{ mobileMenuOpen: false, projectsOpen: true }">
    ...
    <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between px-6 py-3 lg:px-8">
        ...
        <div class="flex items-center gap-x-4">
            <a href="{{ $homeUrl }}" wire:navigate.hover class="flex items-center gap-x-3" aria-label="{{ config('brand.display_name', config('brand.name')) }} homepage">
    ...
    >
        ...
        >
            <div class="flex items-center justify-between">
                <a href="{{ $homeUrl }}" wire:navigate class="flex items-center gap-x-3" aria-label="{{ config('brand.display_name', config('brand.name')) }} homepage">
