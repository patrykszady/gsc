<div class="bg-white dark:bg-zinc-900">
    <x-breadcrumbs :items="[['label' => 'Service Area by ZIP']]" padding="pt-10 pb-0" />
    ...
    <div class="mx-auto max-w-7xl px-4 pt-4 pb-10 sm:px-6 lg:px-8">
        ...
        <div class="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            @foreach ($grouped as $cityName => $zips)
                <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-zinc-800">
